...
/**
 * Computes employee compensation; persistence delegated to PayrollRepository (OOP redesign - GEAR.HR).
 */
public class PayrollProcessor {
    private final PayrollRepository repository;
    private final Map<String, PayrollData> payrollData = new HashMap<>();

    public PayrollProcessor(PayrollRepository repository) {
    ...
    public void savePayrollDataToCSV() {
        ...
        for (Map.Entry<String, PayrollData> e : payrollData.entrySet()) {
            ...
            toSave.put(e.getKey(), new PayrollData(
