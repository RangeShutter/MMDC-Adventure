...
public class EmployeeProfile extends BaseModuleScreen implements ModuleScreen {
    ...
    private static void createPayrollDataTable() {
        String[] columns = {
            "Employee Number", "Last Name", "First Name", "Base Salary", "SSS", "PhilHealth",
            "Pag-IBIG", "Withholding Tax", "Rice Subsidy", "Phone Allowance", "Clothing Allowance", "Net Salary"
        };
    ...
    private static void updatePayrollDataTable() {
        ...
        for (Employee emp : employeeService.getAllEmployees()) {
            ...
            payrollTableModel.addRow(new Object[] {
                ...
                emp.getLastName(),
                emp.getFirstName(),
                String.format("%.2f", data.getBaseSalary()),
    ...
    private static void showNewEmployeeForm(JFrame parentFrame) {
        ...
        addFormField(mainPanel, "Base Salary:", salaryField, gbc, 12);
